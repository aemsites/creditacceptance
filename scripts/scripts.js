...
export function buildEmbedBlocks(main) {
  main.querySelectorAll('a[href]').forEach((a) => {
    if ((a.href.includes('youtu') || a.href.includes('vimeo') || a.href.includes('www.google.com/maps/embed')) && linkTextIncludesHref(a) && !a.closest('.block.embed') && !a.closest('.block.video-carousel')) {
